...
class Network(nn.Module):
    def __init__(self, args, num_classes, criterion, norm_layer, pretrained_model=None):
        super(Network, self).__init__()
        self.branch1 = SingleNetwork(args, num_classes, criterion, norm_layer, pretrained_model)
        self.branch2 = SingleNetwork(args, num_classes, criterion, norm_layer, pretrained_model)
...
class SingleNetwork(nn.Module):
    def __init__(self, config, num_classes, criterion, norm_layer, pretrained_model=None):
        super(SingleNetwork, self).__init__()
        self.backbone = resnet.resnet101(pretrained_model, norm_layer=norm_layer,
...
@register('deeplab-cps')
def make_deeplab(num_classes=16, bn_eps=1e-5, bn_momentum=0.1):
    args = Namespace()
    ...
    return SingleNetwork(args, args.num_classes, criterion=args.criterion, 
    pretrained_model=args.pretrained_model, norm_layer=args.BatchNorm2d)
...
if __name__ == '__main__':
    ...
    # with torch.no_grad():
        # summary(deeplab.to('cuda'), input_size=(3, 512, 512), batch_size=1)