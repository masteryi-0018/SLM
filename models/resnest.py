...
class ResNet(nn.Module):
    ...
    def _load_pretrained_model(self):
        # pretrain_dict = model_zoo.load_url('https://github.com/zhanghang1989/ResNeSt/releases/download/weights_step1/resnest101-22405ba7.pth')
        pretrain_dict = torch.load('pretrained/resnest101.pth')
        model_dict = {}
...
if __name__ == '__main__':
    ...
    model = resnest101(pretrained=True).eval()
