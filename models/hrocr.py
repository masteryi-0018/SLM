# -*- coding: utf-8 -*-
"""
Created on Thu Jan 27 13:21:07 2022
...
# not torch.__version__.startswith('0')
...
class HighResolutionNet(nn.Module):
    ...
    def __init__(self, config, pretrained=True, **kwargs):
    ...
    def _load_pretrained_model(self):
        ...
        pretrain_dict = torch.load('pretrained/hrnet_ocr_ade20k_4451_torch04.pth')
        model_dict = {}
...
def hrnet_w48(pretrained=True, **kwargs):
    ...
    model = HighResolutionNet(hrnet_w48_dct, pretrained=pretrained, **kwargs)
...
if __name__ == '__main__':
    ...
    model = hrnet_w48(pretrained=True).eval()
